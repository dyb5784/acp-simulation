...
## [4.1.0] - 2025-12-24 -  2026 Conference Edition
...
- **`EnhancedEpisodeResult`** dataclass
  - `restore_node_count`:  validation metric (41.85% vs 33.4%)
...
#### Documentation
- `_ENHANCEMENTS_SUMMARY.md` - Technical details
...
### Git Information
- Branch: `feat/enterprise-topologies-v4.1`
- Commit: `103d91e`
