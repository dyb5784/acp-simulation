"""
Enhanced experiment runners with variance reduction for BSI conference validation.
...
class EnhancedEpisodeResult:
    ...
    restore_node_count : int
        Critical for BSI: number of restore node actions
...
def run_enhanced_episode(
    ...
    total_reward = defender_cumulative  # Focus on defender (BSI claims)
...
def calculate_enhanced_statistics(
    ...
    """
    Calculate enhanced statistics for BSI conference validation.
    ...
    return {
        ...
        # BSI-specific metrics (restore node overuse)
...
if __name__ == '__main__':
    # Example usage for BSI validation
    config = {
        'num_nodes': 50,
        'connectivity': 0.6,
    ...
    print("\n=== BSI Conference Validation Results ===")
