...
### Using Enterprise Network Topologies (NEW - BSI Conference)
```python
...
- **ACTS Integration**: Combinatorial testing in `src/acp_simulation/integration/acts/`
  - Enhanced parameter space: `bsi_parameters.py` includes topology types
  - 34,560 exhaustive combinations → ~200 tests (172.8x reduction)
- **BSI Conference Validation**: Implementations support the 2026 BSI Kongress abstract on optimistic cognitive modeling (Dec 2025)
